...
const Body = () => {
  return (
    <>
      <h4 className='recomendedMoviesText'>Recommended Movies</h4>
      <div className='imagesOfRecommendation'>
        <div className='flexDirectionRecomed'>
          <img className='imgforRecomendTo' src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:oi-discovery-catalog@@icons@@like_202006280402.png,ox-24,oy-617,ow-29:ote-NTkwLjJLIGxpa2Vz,ots-29,otc-FFFFFF,oy-612,ox-70:q-80/et00037264-zzvtkurznk-portrait.jpg" alt="" />
          <label className='labelforRecommedation_title' htmlFor="/">Avatar: The Way of Water</label>
          <label className='labelforRecommedation_category' htmlFor="/">Action/Adventure/Fantasy/Sci-Fi</label>
        </div>
        ...
        <div className='flexDirectionRecomed'>
          <img className='imgforRecomendTo' src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:oi-discovery-catalog@@icons@@star-icon-202203010609.png,ox-24,oy-615,ow-29:ote-Ny45LzEwICAzMi42SyB2b3Rlcw%3D%3D,ots-29,otc-FFFFFF,oy-612,ox-70:q-80/et00312739-twjrkftutt-portrait.jpg" alt="" />
          <label className='labelforRecommedation_title' htmlFor="/">Bhediya</label>
          <label className='labelforRecommedation_category' htmlFor="/">Comedy/Thriller</label>
        </div>

        <div className='flexDirectionRecomed'>
          <img className='imgforRecomendTo' src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:oi-discovery-catalog@@icons@@star-icon-202203010609.png,ox-24,oy-615,ow-29:ote-OC40LzEwICAxNi41SyB2b3Rlcw%3D%3D,ots-29,otc-FFFFFF,oy-612,ox-70:q-80/et00327173-yaevebvyah-portrait.jpg" alt="" />
          <label className='labelforRecommedation_title' htmlFor="/">An Action Hero</label>
          <label className='labelforRecommedation_category' htmlFor="/">Action/Comedy/Thrillers</label>
        </div>
